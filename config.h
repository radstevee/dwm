...
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "ZedMono NerdFont:style:bold:pixelsize=16", "-g", "50x20", "-e", "bc", "-lq", NULL};
...
/* autostart */
static const char *autostartcmds[] = {"~/.config/startup.sh"};
...
static const Key keys[] = {
  ...
  { MODKEY | ShiftMask,            XK_v,        togglesmartgaps, {0} },
